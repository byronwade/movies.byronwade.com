//#region node_modules/.nitro/vite/services/ssr/assets/db-LiLrRnNM.js
...
var _0002_kino_default = "create table if not exists kino_state (\n  user_id text primary key,\n  payload jsonb not null default '{}'::jsonb,\n  updated_at timestamptz not null default now()\n);\n";
/**
...
async function createPgliteSql() {
	...
	const migrate = async () => {
		const migrations = /* #__PURE__ */ Object.assign({
			...
			"/migrations/0002_kino.sql": _0002_kino_default
		});
