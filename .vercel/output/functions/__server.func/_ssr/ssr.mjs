...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-DlqWoAXX.mjs");
...
var manifest = {
	"0db941931ccf4e2d979316ead45c780ed465dc80e2c2766feb3bb57fcb0241cd": {
		functionName: "pullMailLibrary_createServerFn_handler",
		importer: () => import("./ambient-C2ngiVhb.mjs")
	},
	"718e7176558e73f738648fc8c56ca22fbe586506ac610f9f9f4f43574a26ae28": {
		functionName: "importLibrary_createServerFn_handler",
		importer: () => import("./import-BS-fUEjY.mjs")
	},
	"dd61b80e7e8b6581fc8b8b1749bc3bf06cd64556a7f7dead94015fd3542e7d47": {
		functionName: "pullKinoState_createServerFn_handler",
		importer: () => import("./sync-xWnFKGqR.mjs")
	},
	"ebc8f5eae66de4bb06ac5b7dbdebb422b6be92d68616939a83fd079b9e3845af": {
		functionName: "pushKinoState_createServerFn_handler",
		importer: () => import("./sync-xWnFKGqR.mjs")
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-C1Q_u6JZ.mjs").then((n) => n.t),
